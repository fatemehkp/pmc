...
ggsave(here('output', 'plot','Figure 5.jpeg'), width = 7.5, height = 8.5, dpi = 600)
```
...
ggsave(here('output', 'plot','Figure 6.jpeg'), width = 7.5, height = 6.5, dpi = 600)
```
...
Plot.Multi.lab(dt = data, ggtheme = ggtheme.multi.1, n = 1) +
ggsave(here('output', 'plot','Figure 7.jpeg'), width = 7.5, height = 7.5, dpi = 600)
```
...
Plot.Multi(dt = data, ggtheme = ggtheme.multi.2, n = 1) +
ggsave(here('output', 'plot','Figure 8.jpeg'), width = 7.5, height = 6.5, dpi = 600)
```
...
Plot.Multi.lab(dt = data, ggtheme = ggtheme.multi.1, n = 1) +
ggsave(here('output', 'plot','Figure 9.jpeg'), width = 7.5, height = 7.5, dpi = 600)
```
...
Plot.Multi(dt = data, ggtheme = ggtheme.multi.2, n = 1) +
ggsave(here('output', 'plot','Figure 10.jpeg'), width = 7.5, height = 6.5, dpi = 600)
```
...
Plot.Multi.lab(dt = data, ggtheme = ggtheme.multi.1, n = 1) +
ggsave(here('output', 'plot','Figure 11.jpeg'), width = 7.5, height = 7.5, dpi = 600)
```
...
Plot.Single.lab(dt = data, ggtheme = ggtheme.single) +
ggsave(here('output','plot','Figure S3.jpeg'), width = 7.5, height = 6.5, dpi = 600)
```
...
Plot.Multi.lab(dt = data, ggtheme = ggtheme.multi.1, n = 1) +
ggsave(here('output', 'plot','Figure S5.jpeg'), width = 7.5, height = 8.5, dpi = 600)
```
...
Plot.Multi.lab(dt = data, ggtheme = ggtheme.multi.1, n = 1) +
ggsave(here('output', 'plot','Figure S7.jpeg'),width = 7.5, height = 8.5, dpi = 600)
```
...
Plot.Multi.lab(dt = data, ggtheme = ggtheme.multi.1, n = 1) +
ggsave(here('output', 'plot','Figure S8.jpeg'), width = 7.5, height = 7.5, dpi = 600)
```
...
Plot.Multi.lab(dt = data, ggtheme = ggtheme.multi.1, n = 1) +
ggsave(here('output', 'plot','Figure S9.jpeg'), width = 7.5, height = 8.5, dpi = 600)
```
...
Plot.Multi.lab(dt = data, ggtheme = ggtheme.multi.1, n = 1) + 
ggsave(here('output', 'plot','Figure S10.jpeg'), width = 7.5, height = 9.5, dpi = 600)
```
