...
```{r Call Functions}
source(here('code','data-viz','plot-functions.R'))
```
...
```{r set theme 2 - effect modification, subgroups, multiple groups plots}
...
```{r set theme 3 - effect modification, subgroups, multiple groups plots}
...
Plot.Multi(dt = data, ggtheme = ggtheme.multi.1) +
...
Plot.Multi(dt = data, ggtheme = ggtheme.multi.2) +
