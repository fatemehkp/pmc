...
pmcres <- c("PM_AS","PM_CA","PM_CL","PM_NA","PM_NI","PM_NO3",
...
pmc.sub <- c("AS","CA","CL","NA","NI","NO3","OC",
             "PB","PM","SI","SO4","V","ZN")
```

```{r List of PM Components Yr Sub}
pmc.sub.yr <- c("Yr_AS","Yr_CA","Yr_CL","Yr_NA","Yr_NI","Yr_NO3","Yr_OC",
...
sep=,
# the predictors are included in the model
predictors=Yr_exposure, ses, BMI, Race, Smoke, Diabt, Asthma, Drink
# stratas
stratas=StrID, SiteID
# death
death=no_death_outcome
