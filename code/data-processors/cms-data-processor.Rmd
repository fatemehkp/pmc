...
dt.master.ndi.pmc.bz6 <- read.csv(here('data', 'processed','master_ndi_pmc_bz6.csv')) %>% 
  rename(Site.ID = Site_ID,
         Year = year,
         Month = MONTH,
         age = ENROLLEE_AGE)
save(dt.master.ndi.pmc.bz6, file = here('data', 'processed', 'master-ndi-pmc-bz6.RDa'))

dt.master.ndi.pmc.bz12 <- read.csv(here('data', 'processed','master_ndi_pmc_bz12.csv')) %>% 
  rename(Site.ID = Site_ID,
         Year = year,
         Month = MONTH,
         age = ENROLLEE_AGE)
save(dt.master.ndi.pmc.bz12, file = here('data', 'processed', 'master-ndi-pmc-bz12.RDa'))

dt.master.ndi.pmc.bz24 <- read.csv(here('data', 'processed','master_ndi_pmc_bz24.csv')) %>% 
  rename(Site.ID = Site_ID,
         Year = year,
         Month = MONTH,
         age = ENROLLEE_AGE)
save(dt.master.ndi.pmc.bz24, file = here('data', 'processed', 'master-ndi-pmc-bz24.RDa'))
```
...
write.csv(dt.ndi.pmc.residual, file = here('data', 'processed', 'ndi-pmc-residual.csv'),
          row.names = F)
```
...
write.csv(dt.ndi.pmc.raceA, file = here('data', 'processed', 'ndi-pmc-raceA.csv'),
          row.names = F)
...
dt.raceB <- aggregate(. ~ Site.ID + Year + Month + age + sex + race, dt.raceB, sum) %>%
  arrange(Site.ID, Year, Month, age, sex, race)
...
write.csv(dt.ndi.pmc.raceB, file = here('data', 'processed', 'ndi-pmc-raceB.csv'),
          row.names = F)
...
dt.raceH <- aggregate(. ~ Site.ID + Year + Month + age + sex + race, dt.raceH, sum) %>%
  arrange(Site.ID, Year, Month, age, sex, race)
...
write.csv(dt.ndi.pmc.raceH, file = here('data', 'processed', 'ndi-pmc-raceH.csv'),
          row.names = F)
...
dt.raceW <- aggregate(. ~ Site.ID + Year + Month + age + sex + race, dt.raceW, sum) %>%
  arrange(Site.ID, Year, Month, age, sex, race)
...
write.csv(dt.ndi.pmc.raceW, file = here('data', 'processed', 'ndi-pmc-raceW.csv'),
          row.names = F)
```
...
write.csv(dt.ndi.fac.raceA, file = here('data', 'processed', 'ndi-fac-raceA.csv'),
          row.names = F)
...
write.csv(dt.ndi.fac.raceB, file = here('data', 'processed', 'ndi-fac-raceB.csv'),
          row.names = F)
...
write.csv(dt.ndi.fac.raceH, file = here('data', 'processed', 'ndi-fac-raceH.csv'),
          row.names = F)
...
write.csv(dt.ndi.fac.raceW, file = here('data', 'processed', 'ndi-fac-raceW.csv'),
          row.names = F)
```
...
write.csv(dt.ndi.pmc.urban, file = here('data', 'processed', 'ndi-pmc-urban.csv'),
          row.names = F)
...
write.csv(dt.ndi.pmc.rural, file = here('data', 'processed', 'ndi-pmc-rural.csv'),
          row.names = F)
```
...
write.csv(dt.ndi.pmc.urban.sesL, file = here('data', 'processed', 'ndi-pmc-urban-sesL.csv'),
          row.names = F)
...
write.csv(dt.ndi.pmc.urban.sesM, file = here('data', 'processed', 'ndi-pmc-urban-sesM.csv'),
          row.names = F)
...
write.csv(dt.ndi.pmc.urban.sesH, file = here('data', 'processed', 'ndi-pmc-urban-sesH.csv'),
          row.names = F)
```
...
write.csv(dt.ndi.pmc.west, file = here('data', 'processed', 'ndi-pmc-west.csv'),
          row.names = F)
...
write.csv(dt.ndi.pmc.midwest, file = here('data', 'processed', 'ndi-pmc-midwest.csv'),
          row.names = F)
...
write.csv(dt.ndi.pmc.south, file = here('data', 'processed', 'ndi-pmc-south.csv'),
          row.names = F)
...
write.csv(dt.ndi.pmc.northeast, file = here('data', 'processed', 'ndi-pmc-northeast.csv'),
          row.names = F)
```
...
dt.age <- aggregate(. ~ Site.ID + Year + Month + age + sex + race, dt.age, sum) %>%
  arrange(Site.ID, Year, Month, age, sex, race)
...
write.csv(dt.ndi.pmc.ageLE75, file = here('data', 'processed', 'ndi-pmc-ageLE75.csv'),
          row.names = F)
...
write.csv(dt.ndi.pmc.ageM75, file = here('data', 'processed', 'ndi-pmc-ageM75.csv'),
          row.names = F)
```
...
write.csv(dt.ndi.pmc.sexF, file = here('data', 'processed', 'ndi-pmc-sexF.csv'),
          row.names = F)
...
write.csv(dt.ndi.pmc.sexM, file = here('data', 'processed', 'ndi-pmc-sexM.csv'),
          row.names = F)
```
...
write.csv(dt.ndi.pmc.brfss, file = here('data', 'processed', 'ndi-pmc-brfss.csv'),
          row.names = F)
```
...
write.csv(dt.ndi.pmc, file = here('data', 'processed', 'ndi-pmc-bz6.csv'),
          row.names = F)
```
...
write.csv(dt.ndi.pmc, file = here('data', 'processed', 'ndi-pmc-bz12.csv'),
          row.names = F)
```
...
write.csv(dt.ndi.pmc, file = here('data', 'processed', 'ndi-pmc-bz24.csv'),
          row.names = F)
```
...
write.csv(dt.ndi.pmc, file = here('data', 'processed', 'ndi-pmc-5yr.csv'),
          row.names = F)
```
...
write.csv(dt.ndi.pmc, file = here('data', 'processed', 'ndi-pmc-4yr-5yr.csv'),
          row.names = F)
```
...
write.csv(dt.ndi.pmc, file = here('data', 'processed', 'ndi-pmc-3yr-5yr.csv'),
          row.names = F)
```
...
write.csv(dt.ndi.pmc, file = here('data', 'processed', 'ndi-pmc-2yr-5yr.csv'),
          row.names = F)
```
...
write.csv(dt.ndi.pmc, file = here('data', 'processed', 'ndi-pmc-1yr-5yr.csv'),
          row.names = F)
```